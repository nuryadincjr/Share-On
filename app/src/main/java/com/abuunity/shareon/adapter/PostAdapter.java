...
import com.abuunity.shareon.activity.CommentActivity;
import com.abuunity.shareon.Interface.ItemClickListener;
import com.abuunity.shareon.activity.DetailPostActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imagePost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("tools", (Parcelable) posts.getToolsList());
                intent.putExtra("steps", (Parcelable) posts.getStepsList());
                context.startActivity(intent);
            }
        });
    }
